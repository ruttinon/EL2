...
import { getConfigDir, getDataDir, getDatabasePath, getGraphicsDir, getImagesDir, getLogsDir, getReportsDir, getDriversDir } from './paths.js';
...
function normalizeRuntimeWriteMode(value, fallback) {
    return value === 'normal' || value === 'read_only' ? value : fallback;
}
export function normalizeEngineConfig(input) {
...
export function writeEngineConfig(config) {
